...
**審査却下後の再提出（2.1(b) IAP / 1.5 サポート URL 等）** の推奨作業順・審査メモのコピペは、[AppReview 再提出チェックリスト](./AppReview_再提出チェックリスト.md) の冒頭と各セクションを参照。
...
| 2026-04-04 | §14 に再提出用チェックリスト（推奨作業順・審査メモ）への参照を追加 |
